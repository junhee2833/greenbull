...
5. 한국어로 작성합니다.
6. 모든 분석은 비전공자도 직관적으로 이해할 수 있도록 전문 용어와 영어 약어(MoM, TGA, RRP 등)를 철저히 배제하고, 그 경제적 본질을 쉬운 한국어 표현으로 풀어서 기술하십시오`;
...
6. 한국어로 작성합니다.
7. 모든 분석은 비전공자도 직관적으로 이해할 수 있도록 전문 용어와 영어 약어(MoM, TGA, RRP 등)를 철저히 배제하고, 그 경제적 본질을 쉬운 한국어 표현으로 풀어서 기술하십시오`;
